We're going to add a new step to the onboarding process, "Your First Recipes." Once we have the ingredients, utensils, and user preferences, we can generate two recipes using the Google AI API.
